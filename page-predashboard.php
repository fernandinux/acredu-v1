        ...
        <div class="mx-3 my-5" >
            <div class="card" style="width:320px">
                            ...
                            <div style="height:120px">
                                ...
                                <a href="<?php the_permalink(); ?>?idcat=<?php echo $idcategory ?>&empresa=<?php echo $nameempresa ?>">
                                <p class="card-title" style="display: inline;"><?php the_title(); ?></p></a>                                 
                                ...
                                <a href="https://acredu.app/addlistperson/?empresa=Socialab&curso=<?php the_field('nombrecurso'); ?>&idcat=74"
