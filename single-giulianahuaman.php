	...
	<div class="row pt-3 align-middle">
			...
			<div class="d-md-flex justify-content-sm-between">
				...
				<div class="d-flex flex-column my-auto ml-lg-4 ml-sm-2 text-lg-left text-center">
					<div class="text-center">
						<a target="_blank" id="logousach" href="https://www.linkedin.com/in/giulianahuaman/" class="">
							<img alt="Colectivo23" src="https://app.acredu.org/wp-content/uploads/2021/01/cropped-favicon.png" class="w-sm-75 w-25 img-fluid mx-auto" data-pagespeed-url-hash="2790086286" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
						</a>
					</div>
					<div>
						<a target="_blank" href="https://www.linkedin.com/in/giulianahuaman/">https://www.linkedin.com/in/giulianahuaman/
						</a>
		...
		<div class="col-md-4 col-sm-12 text-center">
            ...
            <div style="margin: 20px auto;">
				...
				<a target="_blank" href="https://wa.link/isu2r7" style="cursor: pointer;text-decoration: none;">
